...
Status: prepared copy only; no fork, branch, pull request, or maintainer message has been created.

## First target: Awesome Scientific Skills

Repository:

https://github.com/InternScience/Awesome-Scientific-Skills

Best section: Science-Specific → Academic Writing.

Its current contribution instructions ask contributors to add a concise skill link in the appropriate section and explain why it is useful for scientific research. Recheck the live table columns and contribution text immediately before editing because the list can change.

### Current three-column table entry
...
Add CNS Skills to Academic Writing
...
Adds [CNS Skills](https://github.com/niuyupeng/CNS-Skills) to the Academic Writing section.
...
Check the live contribution rules before preparing a change:
...
- Submit to one high-fit list first; wait for maintainers' feedback before adapting to others.
- Follow each repository's alphabetical order, punctuation, description length, license, and testing requirements.
- Do not submit to a list that requires a star threshold or external adoption until the requirement is genuinely met.
- Do not copy the same promotional paragraph into unrelated lists.
- Do not request reciprocal stars, votes, or expedited review.
- Do not state that a list has accepted or audited CNS Skills before its merged entry is visible.
- Update CURRENT_STAR_COUNT and every proof number from live data at pull-request time.
