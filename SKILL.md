---
name: cns-skills
description: English-first, bilingual scientific writing and revision benchmarked to Cell, Nature, Science, and leading-conference standards. Use when the user asks to draft, translate, revise, humanize, polish, peer-review, verify citations, strengthen argumentation, design or audit figures/tables, or prepare an English or Chinese manuscript, review, grant, rebuttal, or research document for a top venue. Produces submission English from Chinese or English sources, preserves claims and evidence, audits overclaiming, and supports DOCX/PDF visual QA. Does not guarantee acceptance, promise AI-detector evasion, or fabricate evidence.
---
